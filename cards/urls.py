...
urlpatterns = [
    ...
    path('card/<int:pk>/submit-answer/', submit_answer, name='submit-answer'),

    # Authentication
    path('signup/', signup, name='signup'), 
    path('login/', auth_views.LoginView.as_view(template_name='cards/registration/login.html'), name='login'),
